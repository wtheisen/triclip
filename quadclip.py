...
class CLIPModel(nn.Module):
    def __init__(
        ...
        self.audio_projection = ProjectionHead(embedding_dim=audio_embedding)
    ...
    def forward(self, batch):
        ...
        video_embeddings = self.video_projection(batch["video"])
        audio_embeddings = self.video_projection(batch["audio"])
        ...
        # st = time.time()
        total_loss = CL.contrastive_alpha_quad(image_embeddings, text_embeddings, video_embeddings, audio_embeddings, CFG.temperature)
        # et = time.time()
